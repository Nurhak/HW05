...
public class Main {
	...
	// write your code here
        ...
        nPriorityQueue<nPixel> PQLEX = new nPriorityQueue<nPixel>(new nLexicographicalComparison());
        nPriorityQueue<nPixel> PQEUC = new nPriorityQueue<nPixel>(new nEuclideanComparison());
        nPriorityQueue<nPixel> PQBMX = new nPriorityQueue<nPixel>(new nBitMixComparison());
        nPixel [][] image;
